...
const itHasQs = _.curry(x => _.test(/q/ig, x));

const filterQs = _.filter(itHasQs)
...
const max = xs => _.reduce(_keepHighest, 0, xs);
...
const slice = _.curry((a, b, arr) => arr.slice(a, b))
...
const take = _.curry((takes, arr) => slice(0)(takes)(arr))
