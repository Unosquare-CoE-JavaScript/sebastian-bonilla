...
const ClapContainer = ({children, setRef, handleClick, ...restProps}) => {
  return <button ref={setRef} className={styles.clap} onClick={handleClick} {...restProps}>
    {children}
  </button>
}
...
const Usage = () => {
  ...
  return <ClapContainer setRef={setRef} data-refkey='clapRef' {...togglerProps}>
    <ClapIcon isClicked={isClicked}/>
    <ClapCount count={count} setRef={setRef} data-refkey="clapCountRef" {...counterProps} />
